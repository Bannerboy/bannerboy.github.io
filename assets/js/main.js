...
this.classList.add("media-image")}function k(){return{width:Math.max(document.documentElement.clientWidth,window.innerWidth||0),height:Math.max(document.documentElement.clientHeight,window.innerHeight||0)}}function l(a){a=a.getBoundingClientRect();return{top:a.top+(document.documentElement.scrollTop||document.body.scrollTop),left:a.left+(document.documentElement.scrollLeft||document.body.scrollLeft)}}function u(a,c){var b=k(),d=b.width/(a.offsetWidth+20),b=b.height/(a.offsetHeight+20);c&&(d=Math.min(d,
